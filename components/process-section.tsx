    ...
    <section id="process" className="py-20 bg-gradient-to-br from-aco-navy to-aco-navy/95 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="text-xl md:text-2xl text-white max-w-4xl mx-auto leading-relaxed animate-fade-in-up" style={{ animationDelay: "200ms" }}>
        ...
        <div className="max-w-6xl mx-auto relative">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {steps.map((step, index) => (
              <Card
                key={index}
                className="group border-0 shadow-xl hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 bg-white/95 backdrop-blur-sm animate-fade-in-up relative"
              ...
              >
                ...
                <CardContent className="p-8 text-center pt-12">
                  ...
                  <div className="absolute bottom-0 left-0 w-full h-1 bg-gradient-to-r from-aco-orange to-orange-500 transform scale-x-0 group-hover:scale-x-100 transition-transform duration-500 origin-left"></div>
                </CardContent>
              </Card>
            ))}
          </div>
