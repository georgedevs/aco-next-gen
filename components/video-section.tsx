        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-16">
            <div className="relative w-40 h-40 mx-auto mb-8">
              <div className="meet-image before:animate-pulse after:animate-pulse w-max">
                <Image
                src="/student1.jpeg"
                alt="Tega - Developer & Mentor"
                fill
                className="relative z-[1] rounded-full object-cover border-4 border-aco-orange shadow-xl"
              />
              </div>
              {/* Professional badge overlay */}
              <div className="absolute z-[2] -bottom-2 -right-2 bg-aco-orange text-white px-3 py-1 rounded-full text-sm font-bold shadow-lg">
                15+ Years
              </div>
            </div>
            
            <h2 className=" text-3xl md:text-4xl font-bold text-aco-navy pt-4 mb-4">Meet Tega</h2>
